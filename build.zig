...
pub fn build(b: *std.Build) void {
    ...
    build_options.addOption([]const u8, "app_version", "0.1.1");
    ...
    const mod = b.addModule("libvaxis_tetris", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "libvaxis_tetris" is the name you will use in your source code to
                // import this module (e.g. `@import("libvaxis_tetris")`). The name is
    ...
    const game_rules_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/game/rules_test.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
